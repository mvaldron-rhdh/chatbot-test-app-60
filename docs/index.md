...
!!! info
    ...
    **Source Code Repository:** [https://github.com/mvaldron-rhdh/chatbot-test-app-60](https://github.com/mvaldron-rhdh/chatbot-test-app-60)

    **GitOps Repository:** [https://github.com/mvaldron-rhdh/chatbot-test-app-60-gitops](https://github.com/mvaldron-rhdh/chatbot-test-app-60-gitops)

# **Usage**

To access the chatbot-test-app-60 application that was deployed using the Software Template, complete the following instructions:
